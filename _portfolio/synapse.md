...
This project studies objective biomarkers for sound sensitivity disorders, including tinnitus, hyperacusis, and misophonia, using multimodal neurophysiological recordings.

The broader SYNAPSE system integrates ear-EEG and pupillometry to measure neural activity and physiological arousal during auditory tasks. My current work focuses on the EEG analysis and neural representation learning side.
...
- Found that robust EEG representations may support objective assessment of auditory disorders.

## Takeaway

This project shows that stable neural representations can be extracted from noisy wearable EEG and linked to clinically meaningful auditory disorder patterns.
